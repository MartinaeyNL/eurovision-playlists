...
import PlaylistCarousel from "../../features/playlist-carousel/PlaylistCarousel";
...
const Home: Component = () => {
    ...
    const playlistsMix = () => playlists()?.filter(((s, idx) => !playlists2025()?.includes(s) && !playlistsNF()?.includes(s) && s.tags.includes('mix')))
    return (
        <div class={styles.Container}>
            ...
            <PlaylistCarousel playlists={playlists2025()} />
        </div>
    )
}
